...
<html lang="en">
  ...
  <body>
    <center>
      <h1 class="display-4">User Registration Info and Delete Individual Users</h1>
        <p class="lead">Ans no 4.</p>
    </center>
          ...
          <table class="table table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a href="index.php?del=<?php echo $id; ?>" class="btn btn-danger">Delete</a></td>
              </tr>
              <?php }  ?>
            </tbody>
          </table>
